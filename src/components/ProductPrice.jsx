...
const ProductPrice = () => {
    return(
        <div id="ProductPrice" className="px-6 xl:px-24 xl:my-20 py-10 xl:py-20 bg-bggray">
            <div className="flex flex-col xl:flex-row justify-center items-center gap-12 xl:gap-6">
                <div className="w-full xl:w-1/2 flex flex-col justify-center items-center xl:items-start xl:pl-15 4xl:pl-50 gap-4 2xl:gap-8">
                    ...
                    <div className="flex flex-col justify-center items-center xl:items-start xl:gap-4 4xl:gap-2">
                        <div className="flex flex-col gap-2">
                            <h3 className="font-normal text-2xl 2xl:text-3xl 4xl:text-4xl text-black">282 mm x 220 mm x 60 mm</h3>
                            <h3 className="font-bold text-3xl 2xl:text-5xl 4xl:text-6xl text-black">Rp. 70.000,- /Pcs</h3>
                        </div>
                        <div className="flex flex-col gap-2 mt-4">
                            <h3 className="font-normal text-2xl 2xl:text-3xl 4xl:text-4xl text-black">280 mm x 220 mm x 45 mm</h3>
                            <h3 className="font-bold text-3xl 2xl:text-5xl 4xl:text-6xl text-black">Rp. 47.500,- /Pcs</h3>
                        </div>
