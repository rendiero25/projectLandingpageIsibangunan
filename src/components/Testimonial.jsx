                    ...
                    <Swiper
                        ...
                        <SwiperSlide>
                            <div className='flex flex-col justify-center items-start gap-4 px-8'>
                                <p className='font-semibold text-xl'>“Kami rutin pesan ratusan food tray untuk kebutuhan 
                        ...
                        <SwiperSlide>
                            <div className='flex flex-col justify-center items-start gap-4 px-8'>
                                <p className='font-semibold text-xl'>"Food tray dari IsiBangunan sangat kokoh dan tahan lama. Kami 
                        ...
                        <SwiperSlide>
                            <div className='flex flex-col justify-center items-start gap-4 px-8'>
                                <p className='font-semibold text-xl'>“Sebagai penyedia catering untuk event besar, kami butuh alat 
                        ...
                        <SwiperSlide>
                            <div className='flex flex-col justify-center items-start gap-4 px-8'>
                                <p className='font-semibold text-xl'>“Saya suka dengan pelayanan cepat dan responsif dari tim IsiBangunan. 
                        ...
                        <SwiperSlide>
                            <div className='flex flex-col justify-center items-start gap-4 px-8'>
                                <p className='font-semibold text-xl'>“Food tray stainless dari IsiBangunan sangat memudahkan 
